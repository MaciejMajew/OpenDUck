...
platformProperties1 = {}
platformProperties1['CudaPrecision'] = 'mixed'
platformProperties1['CudaDeviceIndex'] = '0'

platformProperties2 = {}
platformProperties2['CudaPrecision'] = 'single'
platformProperties2['CudaDeviceIndex'] = '0'
...
simulation = app.Simulation(prmtop.topology, system, integrator, platform, platformProperties1)
...
SMD(system, prmtop, platform, platformProperties2, temperature, positions, velocities, keyInteraction, spring_k, dist_in, dist_fin, SMD_num, save_step, move_force_step)
